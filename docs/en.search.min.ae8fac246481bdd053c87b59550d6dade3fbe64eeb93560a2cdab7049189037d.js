...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fe2bdfb8946f229c17a1897c5145ca77d037cf8614253b4b0eaeb4263c674a16.js',function(){input.required=false;search();});}
