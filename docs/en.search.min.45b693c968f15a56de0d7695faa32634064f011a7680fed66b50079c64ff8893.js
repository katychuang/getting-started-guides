...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a68bcbe44678bdb64180a7e38eb9411a1da0ae05a12393a621f7dea6e4bf3165.js',function(){input.required=false;search();});}
